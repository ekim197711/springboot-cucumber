    ...
    public void createDefaultAliens() {
        alienRepository.saveAll(
                List.of(
                        ...
                        new Alien(null, "Marsian", "Paulina", 60, new BigDecimal("60.676"), 190),
                        new Alien(null, "Marsian", "Lillian", 90, new BigDecimal("91.123"), 190),
                        new Alien(null, "Marsian", "Isabella", 75, new BigDecimal("74.76"), 190),
                        new Alien(null, "Marsian", "Brian", 100, new BigDecimal("100.01"), 190),
                        new Alien(null, "Marsian", "Mike", 115, new BigDecimal("116.123"), 190),
